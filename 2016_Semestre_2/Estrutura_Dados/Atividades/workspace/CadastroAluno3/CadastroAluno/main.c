...
int main(){
    ...
    switch (imprimirMenu()) {
        ...
        case 7: {
            printf("\n Informe o codigo a alterar: ");
            scanf("%d",&numero);
            pesquisarPorCodigo(numero, clientes);
            alterarCliente(numero, clientes);
            break;
            }
        default:
...
//Função Altera cliente
void alterarCliente(int posicao, struct Pessoa **cli){
    printf("\n\n--------Alterar dados--------");
    printf("\nDigite o novo nome do %d. cliente: ", posicao);
    scanf("%s", cli[posicao]->nome);
    fflush(stdin);
    __fpurge(stdin);
    printf("Digite o novo sexo de %s: ", cli[posicao]->nome);
    scanf("%c", &cli[posicao]->sexo);
    printf("Digite o novo salario de %s: ", cli[posicao]->nome);
    scanf("%f", &cli[posicao]->salario);
    printf("Digite o novo CPF de %s: ", cli[posicao]->nome);
    scanf("%s", cli[posicao]->cpf);
